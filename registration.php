<?php
	...
	$con = mysqli_connect("localhost","root","","regform"); //Database connection
...
if(isset($_POST['submit']))
		{
			...
			$telno_perm = mysqli_real_escape_string($con,$_POST['telnoperm']);
			...
			$diploma_college = mysqli_real_escape_string($con,$_POST['diplomacollege']);
			$diploma_university = mysqli_real_escape_string($con,$_POST['diplomauniversity']);
			$diploma_passingyear = mysqli_real_escape_string($con,$_POST['diplomapassingyear']);
			$diploma_percentage = mysqli_real_escape_string($con,$_POST['diplomapercentage']);
